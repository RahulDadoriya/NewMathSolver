...
public class Hemisphere extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO Auto-generated method stub
		ViewGroup view = (ViewGroup) inflater.inflate(R.layout.hemisphere, container, false);
		...
		calculate.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) {
				...
				{
				case 0:
					showResult=(2*pie*no1*no1);
					result.setText(String.valueOf(showResult));
					break;
					
				case 1:
					showResult=(3*pie*no1*no1);
					result.setText(String.valueOf(showResult));
					break;
					
				case 2:
					showResult=(2*pie*no1*no1*no1)/3;
					result.setText(String.valueOf(showResult));
					break;
				}// switch ends here
